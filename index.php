...
<p class="breadcrumb"><a href="/">Inicio</a> &gt; Productos</p>

<?php if(count($categories_array)<=0){?>
<p>No hay fotos para esta categoria, <a href="admin-categories">Cree una o mas categorias</a> antes de subir sus fotos </p>
<?php } ?>
