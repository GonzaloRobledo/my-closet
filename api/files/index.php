...
$PASSWORD = 'Mycloset2023';  // Set the password, to access the file manager... (optional)
...
if($PASSWORD) {
	...
	if(!$_SESSION['_sfm_allowed']) {
		...
		echo '<html><body><form action=? method=post>Contraseña:<input type=password name=p autofocus/></form></body></html>';
		exit;
	}
}
